...
class Controller(polyinterface.Controller):
    ...
    def query_conditions(self):
        ...
        try:
            ...
            Tmin = rd['temp'][self.tag['temp_max_summ']]
            Tmax = rd['temp'][self.tag['temp_min_summ']]
            ...
            et0 = et3.evapotranspriation(Tmax, Tmin, None, et3.kph2ms(Ws), float(self.params.get('Elevation')), rd['rh'][self.tag['humidity_max_summ']], rd['rh'][self.tag['humidity_min_summ']], 51.12, float(self.params.get('Plant Type')), J)
